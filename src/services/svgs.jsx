...
export const Paystack = () =>{
  return(
<img src="/assets/images/paystack.svg" width={20} height={20}/>
  )
}
...
export const Padlock = () =>{
  return(
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-3 text-zinc-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
