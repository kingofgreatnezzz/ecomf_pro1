...
export default function ItemCard({ title, image, price }) {
  return (
    <div className="w-full grid grid-cols-5 mb-4 border py-2 bg-slate-200 rounded-md shadow-md">
      ...
      <div className="col-span-5 md:col-span-3 flex items-center justify-between py-4 md:py-0 px-4 md:px-0 gap-6 md:gap-0">
        ...
        <div className="w-1/3 flex items-center gap-6 text-lg">
          <span className="w-10  h-7 bg-gray-100 text-2xl flex items-center justify-center rounded-md  hover:bg-gray-300 cursor-pointer duration-300 border-[1px] border-zinc-500 hover:border-gray-300">
            -
          </span>
          <p>6</p>
          <span className="w-10  h-7 bg-gray-100 text-2xl flex items-center justify-center rounded-md hover:bg-gray-300 cursor-pointer duration-300 border-[1px] border-zinc-500 hover:border-gray-300">
